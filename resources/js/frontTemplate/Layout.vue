<template>
    ...
    <main>
        <slot name="content" :addToCart="addToCart" :cartCount="cartCount" :cartProduct="cartProduct" :cartTotal="cartTotal" :removeCartData="removeCartData"></slot>
    </main>
...
import getUrlList from '../provider';
    ...
    export default {
        ...
        mounted(){
            var src = [
                '/front_assets/js/popper.min.js','/front_assets/js/bootstrap.min.js',
