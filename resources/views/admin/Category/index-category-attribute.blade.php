                            ...
                            <tbody>
                                @foreach($data as $list)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" onclick="saveData('{{ $list->id }}', '{{ $list->category_id }}', '{{ $list->attribute_id }}')" class="btn btn-outline-primary mb-2"  data-bs-toggle="modal" data-bs-target="#addModal"><i class="bx bx-pen mr-1"></i>Edit </button>
                                            <button type="button" onclick="deleteData('{{ $list->id }}', 'category_attributes')" class="btn btn-outline-danger mb-2" ><i class="bx bx-trash mr-1"></i>Delete </button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Category Attribute</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formSubmit" action="{{ url('admin/updateCategoryAttribute') }}" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                            ...
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    <label for="name" class="col-sm-3 col-form-label">Select Attribute</label>
                                    <div class="col-sm-9">
